...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 0 outbound / 1 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 1 · Changelog: fresh (18 d)</div>
</div>
...
- Pkg folder: [packages\merkle-roots](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\merkle-roots)
...
graph LR
  ...
  merkle_roots["merkle_roots"]:::center
  merkle_anchors["merkle_anchors"]:::inbound -->|FK| merkle_roots
...
- Inbound (relies on this): "merkle_anchors"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package merkle-roots -Apply
