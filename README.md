...
> Lineage: 0 outbound / 1 inbound · ✅ No engine drift detected · Index coverage: ready · PII flags: 1 · Changelog: fresh (18 d)
...
| Pkg folder | [packages\merkle-roots](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\merkle-roots) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package merkle-roots -Apply
