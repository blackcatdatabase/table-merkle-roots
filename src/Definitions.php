...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'merkle_roots'; }
    public static function contractView(): string { return 'vw_merkle_roots'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'subject_table', 'period_start', 'period_end', 'root_hash', 'proof_uri', 'status', 'leaf_count', 'created_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'subject_table', 'period_start', 'period_end' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'leaf_count' ]; }
