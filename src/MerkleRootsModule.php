...
final class MerkleRootsModule implements ModuleInterface
{
    public function name(): string { return 'table-merkle_roots'; }
    public function table(): string { return 'merkle_roots'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_merkle_created', 'idx_merkle_subject' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_merkle_created', 'idx_merkle_subject' ],
            'foreignKeys' => [],
        ];
    }
}
