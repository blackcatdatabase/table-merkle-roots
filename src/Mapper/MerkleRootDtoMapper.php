...
namespace BlackCat\Database\Packages\MerkleRoots\Mapper;

use BlackCat\Database\Packages\MerkleRoots\Dto\MerkleRootDto;
use BlackCat\Database\Packages\MerkleRoots\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO MerkleRootDto:
 ...
 */
final class MerkleRootDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'subject_table' => 'subjectTable', 'period_start' => 'periodStart', 'period_end' => 'periodEnd', 'root_hash' => 'rootHash', 'proof_uri' => 'proofUri', 'status' => 'status', 'leaf_count' => 'leafCount', 'created_at' => 'createdAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'leaf_count' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [];
    /** @var string[] */
    private const DATE_COLS   = [ 'period_start', 'period_end', 'created_at' ];
    /** @var string[] */
    private const BIN_COLS    = [ 'root_hash' ];
     ...
     * @return MerkleRootDto
     */
    public static function fromRow(array $row): MerkleRootDto
    {
        /** @var MerkleRootDto */
    ...
    public static function fromRowOrNull(?array $row): ?MerkleRootDto
    {
     ...
     *
     * @param MerkleRootDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(MerkleRootDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(MerkleRootDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(MerkleRootDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,MerkleRootDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,MerkleRootDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(MerkleRootDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,MerkleRootDto>
     */
