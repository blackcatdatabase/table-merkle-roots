...
namespace BlackCat\Database\Packages\MerkleRoots;
...
use BlackCat\Database\Packages\MerkleRoots\Repository\MerkleRootRepository as GeneratedRepository;
...
{
  private MerkleRootRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof MerkleRootRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected MerkleRootRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\MerkleRoots\Dto\MerkleRootDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\MerkleRoots\Dto\MerkleRootDto|null { return $this->repo->getById($id, $asDto); }
