...
use BlackCat\Database\Packages\MerkleRoots\Repository\MerkleRootRepository;
...
{
    private MerkleRootRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new MerkleRootRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\MerkleRoots\Dto\MerkleRootDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\MerkleRoots\Dto\MerkleRootDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\MerkleRoots\Dto\MerkleRootDto|null
    {
